...
Solicitud* LinkedList_Sol::search_Find(QString email, QString email_Logued)
{
    ...
    while (temp != nullptr)
    {
        if (temp->solicitud->getCorreoEmisor() == email && temp->solicitud->getCorreoReceptor() == email_Logued)
        {
            return temp->solicitud;
        }
        else if (temp->solicitud->getCorreoEmisor() == email_Logued && temp->solicitud->getCorreoReceptor() == email){
            return temp->solicitud;
        }
        temp = temp->next;
    }
